...
- Summary := textpattern plugin wcz_utf8_url – uses UTF-8 permlinks instead of transliterated ones for SEO

- Features := automatically handles non-ASCII characters
...
- Requirements := *Tested with:* Textpattern 4.4.1 – 4.5.7, MySQL 5.1.49, PHP 5.3.3 (Debian Squeeze)

- Download & Installation := Download wcz_utf_url and install it in the usual way.
Adjust Textpattern->Advanced Options->“Maximum URL length (in characters)” to your needs. =:

- Source := Git repository: "*https://github.com/whocarez-textpattern/Unicode-url-for-Textpattern*":https://github.com/whocarez-textpattern/Unicode-url-for-Textpattern =:
